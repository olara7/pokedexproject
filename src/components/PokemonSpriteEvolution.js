...
export default function PokemonSpriteEvolution({ pokemon }) {
    return (
        ...
        <div className="sprite-evo-container">
            ...
            <img src={pokemon.sprites.versions["generation-iv"].platinum.front_default} alt="pokemon yellow sprite"></img>}
            ...
            <img src={pokemon.sprites.versions["generation-v"]["black-white"].animated.front_default} alt="pokemon yellow sprite"></img>}
            ...
            <img src={pokemon.sprites.versions["generation-vi"]["omegaruby-alphasapphire"].front_default} alt="pokemon yellow sprite"></img>}
            ...
            <img src={pokemon.sprites.versions["generation-vii"]["ultra-sun-ultra-moon"].front_default} alt="pokemon yellow sprite"></img>}
